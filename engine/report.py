...
def gerar_relatorio(rankings):
    ...
    ranking_premium = pegar_ranking(rankings, "premium")
    ...
    if not ranking_premium.empty:
        texto.append(f"Melhor premium institucional: {ranking_premium.iloc[0].get('ticker', 'N/A')}")
